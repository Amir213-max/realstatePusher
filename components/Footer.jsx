    ...
    <footer className={`bg-[#1e1e1e] text-[#efefef] ${isRTL ? 'rtl' : 'ltr'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          {/* Most Searched Section - Leftmost */}
          <div>
        ...
        {/* Middle Section: Logo and Social Media on Left, App Downloads on Right */}
        <div className="py-8 border-t border-[#353535]">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            {/* Left: Logo and Social Media Icons (Vertical Stack) */}
            <div className={`flex flex-col ${isRTL ? 'items-end' : 'items-start'} gap-4`}>
              <div className={`flex flex-col ${isRTL ? 'items-end' : 'items-start'} gap-2`}>
                ...
                <p className="text-[#cfcfcf] text-sm text-center w-full">
            ...
            {/* Right: App Downloads */}
            <div className={`flex flex-col items-center ${isRTL ? 'md:items-start' : 'md:items-end'} gap-4`}>
        ...
        {/* Copyright Section */}
        <div className="pt-8 text-center text-sm text-[#cfcfcf]">
